                                ...
                                <div class="swiper-wrapper">
                                            ...
                                            <div class="course-img">
                                                ...
                                                <div
                                                    ...
                                                    <a href="javascript:void(0);" class="brand-icon ms-auto">
                                                        <img src="assets/img/icons/course-01.svg" alt="img"
                                                            class="img-fluid">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="course-content">
                                                <div class="d-flex justify-content-between mb-2">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-2">
                                                            <a href="javascript:void(0);" class="link-default fs-14">David
                                                                Benitz</a>
                                                        </div>
                                                    </div>
                                                    <span
                                    ...
                                    <div class="swiper-slide">
                                        <div class="course-item course-item-two mb-0">
                                            <div class="course-img">
                                                <img src="assets/img/course/course-25.jpg" alt="img"
                                                    class="img-fluid">
                                                <div
                                                    class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-2">
                                                    <a href="javascript:void(0);" class="fav-icon">
                                                    ...
                                                    <a href="javascript:void(0);" class="brand-icon ms-auto">
                                                        <img src="assets/img/featured-courses/Clip-path-group.svg"
                                            ...
                                            <div class="content-course">
                                                <div class="d-flex justify-content-between mb-2">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-2">
                                                            <a href="javascript:void(0);" class="link-default fs-14">Edith
                                                                Dorsey</a>
                                                        </div>
                                                    </div>
                                                    <span
                                    ...
                                    <div class="swiper-slide">
                                        <div class="course-item course-item-two mb-0">
                                            <div class="course-img">
                                                <img src="assets/img/course/course-24.jpg" alt="img"
                                                    class="img-fluid">
                                                <div
                                                    class="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-2">
                                                    <a href="javascript:void(0);" class="fav-icon">
                                                    ...
                                                    <a href="javascript:void(0);" class="brand-icon ms-auto">
                                                        <img src="assets/img/featured-courses/react.svg" alt="img"
                                                            class="img-fluid">
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="event-blog-three blog-three-one" data-aos="fade-up">
                                        ...
                                        <div class="blog-user-top">
                                            <a href="#"><img src="assets/img/user/user-01.jpg"
                                                    alt="">David Benitez</a>
                                        </div>
                                    </div>
                                </div>
