            ...
            <div class="row">
                ...
                <div class="col-lg-4 sidebar-left mt-4 mt-lg-0 theiaStickySidebar">
                    <div class="sticky-top" style="top: 90px;">
                            ...
                            <div>
                                ...
                                <form class="search-form">
                                    <div class="position-relative">
                                        <input type="text" wire:model.live.debounce.3000ms='search'
                        ...
                        <div class="card accordion" id="filtersAccordion">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="empty-state text-center py-5 px-3">
                                ...
                                <h5 class="fw-semibold mb-2">No Blog Posts Yet</h5>

                                <p class="text-muted mb-3">
                                    We haven’t published any articles at the moment. Check back soon for updates,
                                    insights, and stories from our work.
                                </p>
