                            ...
                            <div class="course-item-two course-item mx-0">
                                ...
                                <div class="course-content">
                                    <div class="d-flex justify-content-between mb-2">
                                        <div class="d-flex align-items-center">
                                            <a href="instructor-details.html" class="avatar avatar-sm">
                                                <img src="assets/img/user/user-32.jpg" alt="img"
                                                    class="img-fluid avatar avatar-sm rounded-circle">
                                            </a>
                                            <div class="ms-2">
                                    ...
                                    <h6 class="title mb-2"><a href="course-details.html">Build Responsive Real World
                            ...
                            <div class="course-item-two course-item mx-0">
                                ...
                                <div class="course-content">
                                    <div class="d-flex justify-content-between mb-2">
                                        <div class="d-flex align-items-center">
                                            <a href="instructor-details.html" class="avatar avatar-sm">
                                                <img src="assets/img/user/user-33.jpg" alt="img"
                                                    class="img-fluid avatar avatar-sm rounded-circle">
                                            </a>
                                            <div class="ms-2">
                                                <a href="instructor-details.html" class="link-default fs-14">Carolyn
                                                    Hines</a>
                                            </div>
                                        </div>
                                        <span
                            ...
                            <div class="course-item-two course-item mx-0">
                                ...
                                <div class="course-content">
                                    <div class="d-flex justify-content-between mb-2">
                                        <div class="d-flex align-items-center">
                                            <a href="instructor-details.html" class="avatar avatar-sm">
                                                <img src="assets/img/user/user-34.jpg" alt="img"
                                                    class="img-fluid avatar avatar-sm rounded-circle">
                                            </a>
                                            <div class="ms-2">
                                                <a href="instructor-details.html" class="link-default fs-14">Rafael
                                                    Miller</a>
                                            </div>
                                        </div>
                                        <span
                                    ...
                                    <h6 class="title mb-2"><a href="course-details.html">Build Responsive Websites with
                                            HTML5 and CSS3</a></h6>
                                    <p class="d-flex align-items-center mb-3"><i
                                            class="fa-solid fa-star text-warning me-2"></i>4.4 (180 Reviews)</p>
                                    <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="course-item-two course-item mx-0">
                                ...
                                <div class="course-content">
                                    <div class="d-flex justify-content-between mb-2">
                                        <div class="d-flex align-items-center">
                                            <a href="instructor-details.html" class="avatar avatar-sm">
                                                <img src="assets/img/user/user-35.jpg" alt="img"
                                                    class="img-fluid avatar avatar-sm rounded-circle">
                                            </a>
                                            <div class="ms-2">
                                                <a href="instructor-details.html" class="link-default fs-14">Nancy
                                                    Duarte</a>
                                            </div>
                                        </div>
                                        <span
                                    ...
                                    <h6 class="title mb-2"><a href="course-details.html">Information About Photoshop
                                            Design Degree</a></h6>
                                    <p class="d-flex align-items-center mb-3"><i
                                            class="fa-solid fa-star text-warning me-2"></i>4.4 (180 Reviews)</p>
                                    <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="course-content">
                                    <div class="d-flex justify-content-between mb-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-2">
                                                <a href="instructor-details.html" class="link-default fs-14">James
                                                    Kagan</a>
                                            </div>
                                        </div>
                                        <span
                                    ...
                                    <h6 class="title mb-2"><a href="course-details.html">C# Developers Double Your Coding
