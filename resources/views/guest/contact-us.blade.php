                        ...
                        <div class="card card-body border p-sm-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    ...
                                    <p class="mb-0">
                                        <a href="#"
                                            class="text-gray-5 text-primary-hover text-decoration-underline mb-0">+1 (907)
                                            789-7623</a>
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <p class="mb-0">
                                        <a href="#"
                                            class="text-gray-5 text-primary-hover text-decoration-underline mb-0"><span
                                                class="__cf_email__"
                                                data-cfemail="4d2e2223392c2e390d28352c203d2128632e2220">[email&#160;protected]</span></a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="contact-details">
                            <div class="section-header">
                                ...
                                <p>Get in touch with us to explore how our LMS solution can enhance your e-learning
                                    experience. We're here to help you build a seamless and engaging learning platform!</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
