...
<div class="">
    ...
    <div class="row">
        <div class="col-xl-9">
            <form class="row g-3 mb-6" action="{{ route('pages.update',['page'=>$page->id]) }}" method="POST"
                ...
                <div class="col-md-8">
                    <div class="form-floating">
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="Page Title" value="{{ old('title', $page->title) }}">
                ...
                <div class="col-12">
                    ...
                    <textarea name="content" id="content"
                        ...
                        style="height: 150px">{{ old('content', $page->content) }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <select name="type" id="type"
                            ...
                            <option value="" disabled {{ old('type', $page->type) ? '' : 'selected' }}>Select
                                Type</option>
                            <option value="terms" {{ old('type', $page->type) == 'terms' ? 'selected' : ''
                                }}>Terms</option>
                            <option value="privacy" {{ old('type', $page->type) == 'privacy' ? 'selected' : ''
                                }}>Privacy
                            </option>
                ...
                <div class="col-12 mt-4">
                    <div class="row g-3 justify-content-end">
                        ...
                        <div class="col-auto">
                            <button type="submit" class="btn btn-primary px-5 px-sm-15">Update Page</button>
                        </div>
                    </div>
                </div>
