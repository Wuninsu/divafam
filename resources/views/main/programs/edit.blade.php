...
<div class="">
    ...
    <h2 class="mb-4">Update program</h2>
    <div class="row">
        <div class="col-xl-9">
            <form class="row g-3 mb-6" action="{{ route('programs.update',['program'=>$program->uuid]) }}" method="POST"
                ...
                <div class="col-md-8">
                    <div class="form-floating">
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="program Title" value="{{ old('title', $program->title) }}">
                ...
                <div class="col-12">
                    <div class="form-floating">
                        <textarea name="short_description" id="short_description"
                            ...
                            style="height: 80px">{{ old('short_description', $program->short_description) }}</textarea>
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" id="description"
                        ...
                        style="height: 150px">{{ old('description', $program->description) }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <select name="status" id="status"
                            ...
                            <option value="" disabled {{ old('status', $program->status) ? '' : 'selected' }}>Select
                                status</option>
                            <option value="draft" {{ old('status', $program->status) == 'draft' ? 'selected' : ''
                                }}>Draft</option>
                            <option value="ongoing" {{ old('status', $program->status) == 'ongoing' ? 'selected' : ''
                                }}>Ongoing
                            </option>
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" name="start_date" id="start_date"
                            ...
                            placeholder="Start Date" value="{{ old('start_date', $program->start_date) }}">
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" name="end_date" id="end_date"
                            ...
                            placeholder="End Date" value="{{ old('end_date', $program->end_date) }}">
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" name="location" id="location"
                            ...
                            placeholder="Location" value="{{ old('location', $program->location) }}">
                ...
                <div class="col-md-3">
                    <div class="form-floating">
                        <input type="number" name="budget" id="budget"
                            ...
                            placeholder="Budget" value="{{ old('budget', $program->budget) }}">
                ...
                <div class="col-md-3">
                    <div class="form-floating">
                        <input type="number" name="amount_spent" id="amount_spent"
                            ...
                            placeholder="Amount Spent" value="{{ old('amount_spent', $program->amount_spent) }}">
                ...
                <div class="col-12">
                    <div class="form-floating">
                        <input type="text" name="tags" id="tags"
                            ...
                            placeholder="Tags (comma separated)" value="{{ old('tags', $program->tags) }}">
                ...
                <div class="col-12 mt-4">
                    <div class="row g-3 justify-content-end">
                        ...
                        <div class="col-auto">
                            <button type="submit" class="btn btn-primary px-5 px-sm-15">Update program</button>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        placeholder: 'Enter program over view..',
        tabsize: 2,
        height: 300,
        toolbar: [
        ['style', ['style']],
