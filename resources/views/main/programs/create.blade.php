...
<div class="">
    ...
    <h2 class="mb-4">Create a program</h2>
    <div class="row">
        <div class="col-xl-9">
                ...
                <div class="col-md-8">
                    <div class="form-floating">
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="program Title" value="{{ old('title') }}">
                ...
                <div class="col-12 mt-4">
                    <div class="row g-3 justify-content-end">
                       <div class="col-auto">
                        ...
                        <div class="col-auto">
                            <button type="submit" class="btn btn-primary px-5 px-sm-15">Create program</button>
                        </div>
                    </div>
                </div>
