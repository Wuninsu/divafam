...
<div class="">
    ...
    <div class="row">
        <div class="col-xl-9">
            <form class="row g-3 mb-6" action="{{ route('posts.update', ['post'=>$post->uuid]) }}" method="POST"
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <select name="category_id" id="category_id"
                            class="form-select @error('category_id') is-invalid border-danger @enderror">
                ...
                <div class="col-md-6">
                    ...
                    @if ($post->cover_image)
                    <small class="text-muted">Current: {{ basename($post->cover_image) }}</small>
                    @endif
                ...
                <div class="col-12">
                    ...
                    <textarea name="content" id="content"
                        ...
                        style="height: 180px">{{ old('content', $post->content) }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <select name="status" id="status"
                            ...
                            <option value="" disabled {{ old('status', $post->status) ? '' : 'selected' }}>Select status
                            </option>
                ...
                <div class="col-md-2">
                    <div class="form-check mt-4">
                        <input type="checkbox" name="is_approved" id="is_approved" value="1"
                            ...
                            old('is_approved', $post->is_approved) ? 'checked' : '' }}>
                ...
                <div class="col-12">
                    ...
                    <select name="tags[]" id="tags"
                        class="form-select select2 @error('tags') is-invalid border-danger @enderror" multiple
                        style="min-height: 58px; padding: 0.375rem 0.75rem; border-radius: 0.375rem;">
                        @foreach ($tags as $tag)
