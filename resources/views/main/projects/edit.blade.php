...
<div class="">
    ...
    <div class="row">
        <div class="col-xl-9">
           <form class="row g-3 mb-6" action="{{ route('programs.update',['project'=>$project->uuid]) }}" method="POST"
            ...
            <div class="col-md-8">
                <div class="form-floating">
                    <input type="text" name="title" id="title"
                        class="form-control @error('title') is-invalid border-danger @enderror" placeholder="Project Title"
            ...
            <div class="col-12">
                <div class="form-floating">
                    <textarea name="short_description" id="short_description"
                        ...
                        style="height: 80px">{{ old('short_description', $project->short_description) }}</textarea>
            ...
            <div class="col-12">
                ...
                <textarea name="description" id="description"
                    class="form-control @error('description') is-invalid border-danger @enderror" placeholder="Description"
                    style="height: 150px">{{ old('description', $project->description) }}</textarea>
            ...
            <div class="col-md-6">
                <div class="form-floating">
                    <select name="status" id="status" class="form-select @error('status') is-invalid border-danger @enderror">
            ...
            <div class="col-md-6">
                <div class="form-floating">
                    <input type="text" name="start_date" id="start_date"
                        ...
                        placeholder="Start Date" value="{{ old('start_date', $project->start_date) }}">
            ...
            <div class="col-md-6">
                <div class="form-floating">
                    <input type="text" name="end_date" id="end_date"
                        ...
                        placeholder="End Date" value="{{ old('end_date', $project->end_date) }}">
            ...
            <div class="col-md-6">
                <div class="form-floating">
                    <input type="text" name="location" id="location"
                        class="form-control @error('location') is-invalid border-danger @enderror" placeholder="Location"
            ...
            <div class="col-md-3">
                <div class="form-floating">
                    <input type="number" name="budget" id="budget"
                        class="form-control @error('budget') is-invalid border-danger @enderror" placeholder="Budget"
            ...
            <div class="col-md-3">
                <div class="form-floating">
                    <input type="number" name="amount_spent" id="amount_spent"
                        ...
                        placeholder="Amount Spent" value="{{ old('amount_spent', $project->amount_spent) }}">
            ...
            <div class="col-md-6">
                <div class="form-check">
                    <input type="checkbox" name="is_featured" id="is_featured" value="1"
                        class="form-check-input @error('is_featured') is-invalid border-danger @enderror" {{ old('is_featured',
            ...
            <div class="col-md-6">
                <div class="form-check">
                    <input type="checkbox" name="is_active" id="is_active" value="1"
                        class="form-check-input @error('is_active') is-invalid border-danger @enderror" {{ old('is_active',
            ...
            <div class="col-12">
                <div class="form-floating">
                    <input type="text" name="tags" id="tags"
                        ...
                        placeholder="Tags (comma separated)" value="{{ old('tags', $project->tags) }}">
