                ...
                <div class="col-md-8">
                    <div class="form-floating">
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="Project Title" value="{{ old('title', $project->title) }}">
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <select name="status" id="status"
                            ...
                            <option value="" disabled {{ old('status', $project->status) ? '' : 'selected' }}>Select
                                status</option>
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" name="location" id="location"
                            ...
                            placeholder="Location" value="{{ old('location', $project->location) }}">
                ...
                <div class="col-md-3">
                    <div class="form-floating">
                        <input type="number" name="budget" id="budget"
                            ...
                            placeholder="Budget" value="{{ old('budget', $project->budget) }}">
